...
public:
	...
	void dfsUtil(int s,int visited[],int &cnt,int check);
	void dfs();
};
...
void Graph::dfsUtil(int s,int visited[],int &cnt,int check)
{
	visited[s]=check;
	cnt++;
